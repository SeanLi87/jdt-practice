    ...
    void mockOnProxy() throws InterruptedException, IOException {
        ...
        stubFor(
                get(urlMatching("/categories_and_latest"))
                        ...
                        .willReturn(aResponse().withBody(Files.readAllBytes(Paths.get("/Users/xin.li/JAVA_TD/jdt-practice/src/main/resources/mock_local.json"))))
        );
        Thread.sleep(100000);
    }
